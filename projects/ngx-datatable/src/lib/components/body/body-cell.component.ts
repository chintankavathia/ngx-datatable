      ...
      <ng-container *ngIf="column.isTreeColumn">
        ...
        >
          <span>
            ...
            <i *ngIf="treeStatus === 'collapsed'" [class]="cssClasses.treeStatusCollapsed ?? 'icon datatable-icon-up'"></i>
            <i *ngIf="treeStatus === 'expanded' || treeStatus === 'disabled'" [class]="cssClasses.treeStatusExpanded ?? 'icon datatable-icon-down'"></i>
          </span>
        </button>
        <ng-template
          *ngIf="column.treeToggleTemplate"
